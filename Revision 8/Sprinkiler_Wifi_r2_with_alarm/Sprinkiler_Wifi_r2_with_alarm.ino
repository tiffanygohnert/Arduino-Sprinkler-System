...
const long utcOffsetInSeconds = -21600;                   //Time Zone Offset in Seconds 

// Time you would like the Sprinklers to turn on automaticly 24h clock
...
if( (TimeHours == AlarmHour) && (TimeMinutes == AlarmMinutes) && (TimeSeconds >= 0) && (TimeSeconds <=10)){
...
else if ((TimeHours == AlarmHour) && (TimeMinutes == AlarmMinutes+30) && (TimeSeconds >= 0) && (TimeSeconds <= 10 )){
